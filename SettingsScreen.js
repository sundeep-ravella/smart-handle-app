...
export default function Settings({ navigation }) {
    ...
    BackgroundGeolocation.on('location', (location) => {
        ...
        console.log(geofence.lat);
        console.log(geofence.long);
        let dist = measure(42.29269178888978, -83.7162452237471, location.latitude, location.longitude);
        console.log(dist);
            ...
            <View style={{flex: 2}}>
                ...
                <Switch
                 ...
                 <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                    ...
                    <Button title='create' onPress={createGeofence}/>
                 </View>
